...
public class PKCS12Example
{
        ...
        throws Exception
    {
        ...
        X509CertificateHolder certHldr = v1Bldr.build(new JcaContentSignerBuilder("SHA1WithRSA").setProvider("SC").build(privKey));

        X509Certificate cert = new JcaX509CertificateConverter().setProvider("SC").getCertificate(certHldr);
        ...
        throws Exception
    {
        ...
        X509CertificateHolder certHldr = v3Bldr.build(new JcaContentSignerBuilder("SHA1WithRSA").setProvider("SC").build(caPrivKey));
